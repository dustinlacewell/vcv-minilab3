...
void MiniLab3::processControlChange(midi::Message &msg) {
    ...
    switch (note) {
        case 1:
            ...
            break;
        case 80: sliders[0]->setTarget(msg.getValue());
            break;
        case 81: sliders[1]->setTarget(msg.getValue());
            break;
        case 82: sliders[2]->setTarget(msg.getValue());
            break;
        case 83: sliders[3]->setTarget(msg.getValue());
            break;
        case 102:
        case 103:
        case 104:
...
struct MiniLab3Widget : ModuleWidget {
    ...
    module) {
        ...
        display->setMidiPort(module ? &module->midiInput :
        NULL);
        addChild(display);
    }
