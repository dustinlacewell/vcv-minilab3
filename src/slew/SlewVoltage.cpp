...
SlewVoltage::SlewVoltage(
    SlewLimitQuantity* slewLimitQuantity, VoltageMode voltageMode, float min,
    float max
) {
...
SlewVoltage::SlewVoltage(
    SlewLimitQuantity* slewLimitQuantity, VoltageMode voltageMode
) {
    this->slewLimitQuantity = slewLimitQuantity;
    this->voltageMode = voltageMode;
    this->min = 0.f;
...
void SlewVoltage::fromJson(
    json_t* rootJ, SlewLimitQuantity* slewLimitQuantity
) {
